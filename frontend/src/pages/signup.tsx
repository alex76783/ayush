...
export default function Signup(){
    ...
    <div className="md:grid grid-cols-2 min-h-screen ">
        <div>
            <div>
                <div className="flex justify-center mt-20 font-bold text-2xl" >CREATE AN ACCOUNT </div>
                <div className="flex justify-center  text-sm text-gray-600">Already have an account ? <Link className='underline' to={"/signin"}>Login</Link> </div>
           </div>
